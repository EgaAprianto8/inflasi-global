...
const Footer = () => {
  return (
    <div className=" sm:px-8 md:px-22 xl:px-10 relative overflow-hidden justify-center items-center flex flex-col w-full h-[800px] bg-hero-news py-10 mt-10 bg-[#5488c4]">
